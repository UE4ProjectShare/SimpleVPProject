...
public:
	...
	UPROPERTY(EditAnywhere, config, meta = (MetaClass = "VPScoutingSubsystemHelpersBase"))
	FSoftClassPath ScoutingSubsystemEditorUtilityClassPath;

	/** GestureManager class to use by the ScoutingSubsystem */
	UPROPERTY(EditAnywhere, config, meta = (MetaClass = "VPScoutingSubsystemGestureManagerBase"))
